...
- Did you make sure to not edit the HTML file?
  - Yes. It was used only for consultation.
- If you added selectors to the CSS, do they target a valid HTML element?
  - The only selector I actually changed was the ".child" -> ".text .child"
  - The rest I just moved around. I must admit it was more intuitive than analytical. Felt like a puzzle.
